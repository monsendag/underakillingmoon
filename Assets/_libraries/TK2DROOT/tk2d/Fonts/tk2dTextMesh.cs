    ...
    void CalcAnchor(out float offsetX, out float offsetY)
    {
        if (_font != null)
        {
	        ...
	        switch (_anchor)
	        {
	            ...
	            case TextAnchor.LowerCenter: offsetX = -width / 2.0f; 	offsetY = height - lineHeight; break;
	            case TextAnchor.MiddleCenter: offsetX = -width / 2.0f; 	offsetY = height / 2.0f - lineHeight; break;
	            case TextAnchor.UpperCenter: offsetX = -width / 2.0f; 	offsetY = -lineHeight; break;
	
	            case TextAnchor.LowerRight: offsetX = -width; 	offsetY = height - lineHeight; break;
	            case TextAnchor.MiddleRight: offsetX = -width; 	offsetY = height / 2.0f - lineHeight; break;
	            case TextAnchor.UpperRight: offsetX = -width; 	offsetY = -lineHeight; break;
