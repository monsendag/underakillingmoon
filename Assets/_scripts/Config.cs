...
{
	public const float DefaultWerewolfAttackRange = 1.5f;
	public const float DefaultWerewolfVisionRange = 7.0f;
	...
	public const float DefaultAlignSlowRadius = 0.05f;
	public const float DefaultAlignTimeToTarget = 0.1f;
